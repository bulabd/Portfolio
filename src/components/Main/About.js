  ...
  return (
    <div className='about'>
      ...
      <div className='skills'>
        ...
        <p><strong className='strong'>Systems and Databases: </strong>PostgreSQL, Git</p>
        <p><strong className='strong'> Testing: </strong>Mocha and Chai, Jest, Cypress, Storybook</p>
      </div>
    </div>
  );
}